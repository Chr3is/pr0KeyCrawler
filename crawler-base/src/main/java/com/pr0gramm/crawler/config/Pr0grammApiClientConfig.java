...
public class Pr0grammApiClientConfig {
    ...
    @Bean
    public Pr0grammClient pr0grammClient(WebClient.Builder webClientBuilder, Nonce nonce, MapperFacade mapper) {
        WebClient pr0ApiClient = createPr0grammApiClient(webClientBuilder);
        Pr0grammClient client = new Pr0grammClient(properties, pr0ApiClient, nonce, mapper);
